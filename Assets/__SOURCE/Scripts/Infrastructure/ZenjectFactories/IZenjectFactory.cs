...
namespace Infrastructure.ZenjectFactories
{
  public interface IZenjectFactory
  {
    ...
    GameObject InstantiateGameObject(PrefabId prefabId);
    GameObject InstantiateGameObject(PrefabId prefabId, Transform parent);
    GameObject InstantiateGameObject(PrefabId prefabId, Vector3 position, Quaternion quaternion, Transform parent);
