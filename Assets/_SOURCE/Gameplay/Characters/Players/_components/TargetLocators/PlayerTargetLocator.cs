...
namespace Gameplay.Characters.Players.TargetLocators
{
  public class PlayerTargetLocator : ITickable
  {
    ...
    public void Tick()
    {
      int count = Physics.OverlapSphereNonAlloc(_transform.position, _configService.GetWeaponConfig(_playerWeaponIdProvider.CurrentId.Value).FireRange, _colliders);
